...
export const userCart = async(req,res)=>{
    ...
    res.json({messsage:"User cart",cart});
};
...
cart.times = cart.items.filter((item)=>item.productId.toString()!== productId)

await cart.save();

res.json({messsage:"Product has been removed from cart"})
